document.addEventListener('DOMContentLoaded', function(){
    ...
    function initSections(){
        let sections = document.querySelectorAll('.card-btn');
        sections.forEach((card) => {
            card.addEventListener('click', ()=> {
                let sectionNumber = parseInt(card.getAttribute('data-section'));
    ...
    function startQuiz(index){
        ...
        function showQuestion(){
            ...
            if(question.questionType === 'mcq'){
                ...
                optionsElement.appendChild(ulElement);
            }else{
        ...
        function checkAnswer(givenAnswer, correctAnswer){
           ...
           if(givenAnswer === correctAnswer || correctAnswer.toLowerCase() === givenAnswer.toLowerCase()){
            ...
            feedbackElement.style.color = 'green';
             ...
             feedbackElement.textContent = `Wrong Answer! Correct answer is: ${correctAnswer}`;
